      ...
      <div className="WRAPPER mt-10" data-aos="fade-down">
        ...
        >
          ...
          <Project_prop
            ...
            img={Portfolio}
            link="https://karthik-balli.netlify.app"
            github_link=""
            react={
          ...
          {/*----Project3------*/}
          <Project_prop
            title="Continous Glucose Monitoring Trace"
            para="Thrive is a website which primarily focuses on improving life-style and well-being"
            img={CGMTrace}
            link="https://karthik-balli.github.io/CGM-Trace/"
            github_link="https://github.com/Karthik-Balli/CGM-Trace"
            html5={
